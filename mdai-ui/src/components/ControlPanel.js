...
export default function ControlPanel(props) {
    const { deviceId, deviceAddress, backendUrl, controllerUrl, connectionStatus, currentPhase, pairingToken, qrPayload, expiresInSeconds, lastHeartbeatSeconds, metrics, logs } = props;
